...
files=("insert-test-users" "insert-imprints" "insert-books" "insert-contributors" "insert-releases" "insert-pricings" "insert-marketings" "insert-endorsements" "insert-issues")
