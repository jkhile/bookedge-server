...
export const bookSchema = Type.Object(
  {
    ...
    bisac_1: Type.String(),
    bisac_1_finalized: Type.Boolean(),
    bisac_2: Type.String(),
    bisac_2_finalized: Type.Boolean(),
    bisac_3: Type.String(),
    bisac_3_finalized: Type.Boolean(),
    ...
    interior_file_name: Type.Optional(Type.String()),
    ...
    media_kit_file_name: Type.Optional(Type.String()),
    discussion_guide_link: Type.String(),
    discussion_guide_file_name: Type.Optional(Type.String()),
    book_trailer_link: Type.String(),
    book_trailer_file_name: Type.Optional(Type.String()),
    cover_reveal_link: Type.String(),
    cover_reveal_file_name: Type.Optional(Type.String()),
    ...
    short_author_bio: Type.String(),
    short_author_bio_finalized: Type.Boolean(),
    amazon_author_bio: Type.String(),
    ...
    drive_folder_id: Type.Optional(Type.String()),
