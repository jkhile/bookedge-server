...
export const marketingSchema = Type.Object(
  {
    ...
    amazon_a1_link: Type.String(),
    a1_description_1: Type.String(),
    a1_text_1: Type.String(),
    a1_is_live_1: Type.Boolean(),
    a1_rejection_reason_1: Type.String(),
    a1_image_1: Type.String(),
    a1_description_2: Type.String(),
    a1_text_2: Type.String(),
    a1_is_live_2: Type.Boolean(),
    a1_rejection_reason_2: Type.String(),
    a1_image_2: Type.String(),
    a1_description_3: Type.String(),
    a1_text_3: Type.String(),
    a1_is_live_3: Type.Boolean(),
    a1_rejection_reason_3: Type.String(),
    a1_image_3: Type.String(),
    notes: Type.String(),
